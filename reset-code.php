...
<head>
    <title>Code Verification | Blog CMS </title>
    <meta charset="UTF-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="register-right text-center px-4 py-4">
                                <h4 class="fw-bold">Code Verification</h4>
                                ...
                                <form action="reset-code" method="POST" autocomplete="off">
                                    ...
                                    <div class="d-grid mb-4">
                                        <input class="btn button-primary" type="submit" name="check-reset-otp" value="Submit">
                                    </div>
                                </form>
                            </div>
                        </div>
