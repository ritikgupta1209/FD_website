                ...
                <div class="page-info">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="all-tags">Tags</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Edit Tag</li>
                        </ol>
                    </nav>
                    <div class="page-options">
                        <a href="all-tags" class="btn btn-primary">All Tags</a>
                    </div>
                </div>
                            ...
                            <div class="card">
                                ...
                                <div class="col-lg-12">
                                            <div class="form-group" id="title">
                                                <label class="control-label" style="font-weight:bold;font-size:1.3rem;color:#717BA2;">Tag Name</label>
                                                <input type="text" id="tag_name" class="form-control" required="" value="<?php echo $row['tag_name']?>" placeholder="Edit Tag name" style="border-radius: 7px;width: 100%;padding: 12px 18px;font-size:15px">
                                                <input type="hidden" id="tag_id" value="<?php echo $id?>">
                                            </div>
                                <div class="form-group pt-3 d-flex justify-content-center">
                                        <button class="btn" id="edit-tag" type="button" style="font-size: 1rem;background-color: #2b8fe9;color: #ffffff;">Edit Tag</button>
