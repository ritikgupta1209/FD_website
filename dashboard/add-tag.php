                            ...
                            <div class="card">
                                ...
                                <div class="col-lg-12">
                                            <div class="form-group" id="title">
                                                ...
                                                <input type="text" id="tag_name" class="form-control" required="" placeholder="Add the Tag name" style="border-radius: 7px;width: 100%;padding: 12px 18px;font-size:15px">
                                                
                                            </div>
                                <div class="form-group pt-3 d-flex justify-content-center">
                                        <button class="btn" id="add-tag" type="button" style="font-size: 1rem;background-color: #2b8fe9;color: #ffffff;">Add Tag</button>
