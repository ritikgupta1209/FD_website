                            ...
                            <div class="card">
                                ...
                                <div class="col-lg-12">
                                            <div class="form-group" id="title">
                                                ...
                                                <input type="text" id="rcomment" class="form-control" required="" placeholder="add reply" style="border-radius: 7px;width: 100%;padding: 12px 18px;font-size:15px">
                                                <input type="hidden" id="comment_id" value="<?php echo $id?>">
                                            </div>
                                            
                                <div class="form-group pt-3 d-flex justify-content-center">
                                        <button class="btn" id="replycomment" type="button" style="font-size: 1rem;background-color: #2b8fe9;color: #ffffff;">Add Reply</button>
            ...
            $(document).ready(function() {
                ...
                $('#replycomment').on('click', function(e) {
                    ...
                    if ($('#rcomment').val() == "") {
                        ...
                        error = error + 'rcomment';
                    } else {

                        formData.append('rcomment', $('#rcomment').val());
                    }
