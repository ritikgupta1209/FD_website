...
$id = $_REQUEST['id'];
$query = "SELECT * from post_comments where comment_uid ='" . $id . "'";
                            ...
                            <div class="card">
                                ...
                                <div class="col-lg-12">
                                            <div class="form-group" id="title">
                                                ...
                                                <input type="text" id="comment" class="form-control" required="" value="<?php echo $row['comment']?>" placeholder="Edit comment" style="border-radius: 7px;width: 100%;padding: 12px 18px;font-size:15px">
                                                <input type="hidden" id="comment_id" value="<?php echo $id?>">
                                            </div>
                                <div class="form-group pt-3 d-flex justify-content-center">
                                        <button class="btn" id="edit-comment" type="button" style="font-size: 1rem;background-color: #2b8fe9;color: #ffffff;">Edit</button>
