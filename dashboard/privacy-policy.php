                            ...
                            <div class="card">
                                ...
                                <div class="col-lg-12">
                                            ...
                                            <div class="form-group" id="title">
                                                ...
                                                <textarea id="msg_description" class="form-control" required=""  placeholder="<?php echo $row['policy']?>" rows="20" style="border-radius: 7px;width: 100%;padding: 12px 18px;font-size:15px"><?php echo $row['policy']?></textarea>
                                                <input type="hidden" id="id" value="<?php echo $id?>">

                                            </div>
                                            
                                <div class="form-group pt-3 d-flex justify-content-center">
                                        <button class="btn" id="p-policy" type="button" style="font-size: 1rem;background-color: #2b8fe9;color: #ffffff;">Update</button>
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                if (data.status == 201) {
                                    ...
                                    window.location.replace("privacy-policy.php");
                                    alert("Updated");
