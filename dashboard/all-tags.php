            ...
            <div class="page-content">
                <div class="page-info">
                    ...
                    <div class="page-options">
                        <a href="add-tag" class="btn btn-primary">Add a New Tag</a>
                    </div>
                </div>
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_array($result)) {
                                                ...
                                                echo "<input type=\"hidden\" id=\"tag_id\" value=\"{$row['tag_id']}\">";
                                                   ...
                                                   echo "<tr> <td>".$i."</td><td>".$row['tag_name']."</td><td>".$newDate."</td><td><a href= \"edittag.php?id={$row['tag_id']}\"   data-toggle= \"tooltip \" data-original-title= \"Edit \"><i class= \"fas fa-pencil-alt \" style=\"color:#7d7d83\"></i></a>
                                                   <button type=\"button\" id=\"delete\" onClick=\"del('{$row['tag_id']}')\" class=\"far fa-trash-alt  \" style=\"border: none;background-color: transparent;color:#7d7d83\"></button>
                                                  </td></tr>";
