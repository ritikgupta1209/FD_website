                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="./">Dashboard</a></li>
                                <li class="breadcrumb-item"><a href="metamask">Settings</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Metamask Details</li>
                        </ol>
                    </nav>
                </div>
                                ...
                                <div class="card-body table-responsive">
                                    ...
                                    <table id="zero-conf" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            $result = mysqli_query($link, "SELECT * FROM `metamask_details`");
                                            $i = 1;
                                            while ($row = mysqli_fetch_array($result)) {
                                                $id = $row['meta_id'];
                                                $userid=$row['user_uid'];
                                            $result2 = mysqli_query($link, "SELECT * FROM `user_login` WHERE `user_uid` = '$userid' ");
                                            ...
                                            $user=$row2['name'];
                                                ...
                                                if($row['meta_status']=="active"){
                                                    $block_post="<button type=\"button\" id=\"block\" onClick=\"block('{$row['meta_id']}')\" class=\"fas fa-ban  \" style=\"border: none;background-color: transparent;color:#7d7d83\"></button>";
                                                }
                                                else{
                                                    $block_post="<button type=\"button\" id=\"unblock\" onClick=\"unblock('{$row['meta_id']}')\" class=\"fas fa-key  \" style=\"border: none;background-color: transparent;color:#7d7d83\"></button>";
    
                                                }
                                                        echo "<tr> <td>".$i."</td><td>".$row['meta_uid']."</td><td>".$user."</td><td>".$row['metamask_address']."</td><td>".$status."</td><td>".$block_post."</td>
                                                   </tr>";
