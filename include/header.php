                        ...
                        <li class="nav-item dropdown">
                            ...
                            ?>
                                ...
                                <ul class="dropdown-menu shadow" aria-labelledby="dropdownMenuLink">
                                            ...
                                            <a href="<?php echo $username; ?>">
                                                <?php 
                                                    if($profile == ''){
                                                        ...
                                                        echo '<img src="'.$profile.'" alt="'.$name.'" class="text-center p-1 shadow-sm dropdown-profile">';
                                                    }
                                                ?>
                                            </a>
                                        </div>   
                                    ...
                                    <li><a class="dropdown-item" href="create-story">Post a Donation</a></li>
                                    <li><a class="dropdown-item" href="stories">Donations History</a></li>
