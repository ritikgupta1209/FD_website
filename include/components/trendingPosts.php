    <section class="trending-post my-5">
        <div class="container">
            <div class="heading mb-4">
                <h2 class="fw-bold">Trending Donations<span>.</span></h2>
            </div>
                                    ...
                                    <div class="card-img p-2">
                                        <a href="<?php echo $row['username']; ?>/<?php echo $row['post_slug']; ?>">
                                            ...
                                            if ($row['featured_image'] == '') {
                                                echo '<img src="assets/images/blogcms.com.png" alt="image" style="height: 125px; width:100%;   object-fit: cover; class="img-fluid shadow">';
                                            } else {
                                                echo '<img src="uploads/featuredImages/' . $row['featured_image'] . '" alt="image" class="img-fluid shadow" style="height: 125px; width:100%;   object-fit: cover; onError="this.onerror=null;this.src=\'assets/images/blogcms.com.png\';">';
                                            }
                                            ?>
                                        </a>
                                        <?php
    ...
    <img src="uploads/profile/' . $row['profile'] . '" alt="" class="img-fluid rounded-circle">
            ...
            <div class="swiper-button">
                <div class="swiper-button-next swiper-button-next-1 shadow"></div>
                <div class="swiper-button-prev swiper-button-prev-1 shadow"></div>
            </div>
        </div>
    </section>